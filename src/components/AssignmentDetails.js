  ...
  return (
    <div className='container mx-auto py-6 ml-10 w-11/12'>
      <div className='flex items-center mb-6'>
        ...
        <h1 className='text-[24px] font-bold text-blue-200'>{assignment.judul}</h1>
      </div>
      ...
      <div className='relative border-2 border-gray-300 p-4 w-full h-[60vh]'>
        ...
        <div className='absolute top-0 right-0 text-red-500 px-7 p-4'>
          <p className='text-lg font-semibold text-[16px]'>{assignment.tanggal}</p>
        </div>
        ...
        <div className='flex mt-[30vh]'>
          {/* file box 1 */}
            <div className='w-1/2 mr-2 h-20 border-2 border-gray-300 flex items-center'>
              <GoDownload className='mr-10 ml-5 w-8 h-8' /> {/* Assuming FaDownload is the imported download icon */}
              <Image src={excelpng} alt='Excel File' className='w-10 h-10 mr-2' /> {/* Assuming excelpng is the imported image */}
      ...
      <div className='flex justify-end'>
        <button type="submit" className="mt-4 bg-gradient-to-r from-[#D32026] to-[#FA6065] hover:bg-blue-700 
